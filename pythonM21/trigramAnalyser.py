...
def trigrammer(fpIn): 
    with open(fpIn, 'r', newline = '') as file:
...
for key in trigramDict.keys():
    n = trigramDict[key]
    trigramDict.update({key : [n, float(n / outcomes)]})

# Writes the result into a csv file.
with open('C:/Users/Marco/Desktop/showcase-musicxml/trigramAnalysisPy.csv', 'w', newline = '') as file:
