...
# Extracts the tenor part of Bach's bwv 153.1 chorale and
...
with open(directory + 'm21CSVTest1.csv', 'w', newline = '') as file:
    ...
    for measure in tenor.getElementsByClass('Measure'):
